...
namespace data_packet {
    ...
    public:
        ...
        [[nodiscard]] uint64_t get_files_size() const {
            return files_size;
        }

        void set_files_size(const uint64_t compressed_files_size) {
            this->files_size = compressed_files_size;
        }
    ...
    private:
        ...
        uint64_t files_size = 0; ///< 处理后包文件与文件头长度总和
